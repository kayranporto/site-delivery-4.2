...
`npm run verify` executa a verificação estrutural, os 59 testes automatizados e o type-check TypeScript das Edge Functions. O empacotamento repete o gate antes de gerar o ZIP e exclui `.git`, `node_modules`, releases anteriores e arquivos ZIP antigos.
...
- [ ] 59 testes automatizados aprovados no commit de release;
