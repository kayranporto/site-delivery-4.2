...
const SHELL = [
  ...
  "./css/modules/client-mobile-4.5.css?v=4.5.7",
  "./css/pages/suporte.css?v=4.2.0",
  "./css/modules/restaurante-4.2.2.css?v=4.5.4",
  "./css/modules/carrinho-4.2.5.css?v=4.5.5",
  "./css/modules/checkout-4.2.3.css?v=4.5.6",
  ...
  "./js/pages/pedido-sucesso.js?v=4.5.7",
  "./js/pages/home.js?v=4.5.1",
  "./js/pages/restaurante.js?v=4.5.3",
  ...
  "./js/core/site-enhancements.js?v=4.4.6"
];
