...
test("shell do service worker inclui assets das versões recentes", () => {
  ...
  for (const arquivo of [
    ...
    "carrinho-4.2.5.css",
    "checkout-4.2.3.css",
    "mobile-pwa-4.2.6.css",
    "operacao-restaurante-4.2.7.css",
    "operacao-restaurante-4.2.7.js",
    "carrinho-4.2.5.js",
    "checkout-4.2.3.js",
    "site-enhancements.js?v=4.4.6"
